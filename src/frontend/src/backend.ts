...
import type { ExternalBlob as _ExternalBlob, PhotoRecord as _PhotoRecord, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPhotoRecord(arg0: string, arg1: PhotoRecord): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPhotoRecord(arg0, await to_candid_PhotoRecord_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deletePhotoRecord(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deletePhotoRecord(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPhotoRecords(): Promise<Array<PhotoRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotoRecords();
...
async function from_candid_PhotoRecord_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PhotoRecord): Promise<PhotoRecord> {
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PhotoRecord>): Promise<Array<PhotoRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PhotoRecord_n17(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_PhotoRecord_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PhotoRecord): Promise<_PhotoRecord> {
